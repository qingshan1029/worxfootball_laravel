...
{{--            </div>--}}
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('match_id') ? 'is-invalid' : '' }}" type="number" name="match_id" id="match_id" value="{{ old('match_id') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('player_id') ? 'is-invalid' : '' }}" type="number" name="player_id" id="player_id" value="{{ old('player_id') }}" required>
